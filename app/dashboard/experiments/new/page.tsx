    ...
    try {
      ...
      const lpRes = await fetch("/api/landing-pages", {
        ...
        body: JSON.stringify({
          ...
          slug: activeSlug || slugify(productName) || "smoke-test",
          status: "live",
          preorderEnabled: offerType === "deposit",
          depositAmount: offerType === "deposit" ? Math.round(Number(depositAmount) || 20) : 0,
          priceAnchor: Math.round(Number(priceAnchor) || 49),
          surveyEnabled: true,
